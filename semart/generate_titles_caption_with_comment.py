...
model_weights = 'weights/model_titles_nostilllife.h5'
...
for image_to_predict in sorted(os.listdir('./imgs')):
    ...
    print(lines[counter] + greedySearch(loaded_image))
    counter += 1
    # print(f'Image {image_to_predict} artist caption: ', greedySearch(loaded_image))
    # print(f'Image {image_to_predict} artist caption: ', beam_search_predictions(loaded_image, beam_index = 3))
